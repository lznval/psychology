...
const circle_line_last = new Vivus(
	'circle_line_last',
	{
		type: 'delayed',
		duration: 200,
...
const preloader_line = new Vivus(
	'preloader_line',
	{
		type: 'delayed',
		duration: 400,
...
;
jQuery(document).ready(function($) {
	$('.consultation__other_time_circle').click(function(event) {
		$('.popup, .vertical, .horizont').toggleClass('open');
	});
});
jQuery(document).ready(function($) {
